...
parser.add_argument('-i', metavar='in-file', type=str, default="/home/phil/hr4e/data/patient_data/hr4e_patient.xml")
...
parser.add_argument('-hxslt', metavar='hr4e-xslt-file', type=str, default="/home/phil/hr4e/templates/hr4e_patient_to_ccd.xslt")
parser.add_argument('-gxslt', metavar='green-xslt-file', type=str, default="/home/phil/hr4e/templates/green_ccd.xslt")
...
make_directory = "/home/phil/hr4e/data/patient_data/" + family_name + "_" + given_name + "_" + docID+ "/"
